...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_160/sim/fpmult64_altera_fp_functions_160_py4gazy.vhd" -work altera_fp_functions_160 -cdslib ./cds_libs/altera_fp_functions_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fpmult64.vhd"                                                                                                                                                
fi
