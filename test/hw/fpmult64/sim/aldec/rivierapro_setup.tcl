...
# ACDS 16.0 211 linux 2019.03.26.17:07:34
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If fpmult64 is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_functions_160/sim/fpmult64_altera_fp_functions_160_py4gazy.vhd" -work altera_fp_functions_160
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fpmult64.vhd"                                                                                             
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L altera_fp_functions_160 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_fp_functions_160 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
