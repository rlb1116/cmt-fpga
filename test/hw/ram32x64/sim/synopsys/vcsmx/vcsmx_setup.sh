...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../ram_1port_160/sim/ram32x64_ram_1port_160_lcifr2i.v" -work ram_1port_160
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram32x64.vhd"                                                             
fi
