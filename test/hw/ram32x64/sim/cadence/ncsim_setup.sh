...
mkdir -p ./libraries/ram_1port_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../ram_1port_160/sim/ram32x64_ram_1port_160_lcifr2i.v" -work ram_1port_160 -cdslib ./cds_libs/ram_1port_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ram32x64.vhd"                                                                                                      
fi
