...
TOP_LEVEL_NAME="fpacc64"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/tools/Intel/quartus/16.0.0.211/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/altera_fp_acc_custom_160/
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/twentynm_atoms_ncrypt.v"      -work twentynm     
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/twentynm_hssi_atoms_ncrypt.v" -work twentynm_hssi
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/twentynm_hip_atoms_ncrypt.v"  -work twentynm_hip 
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_acc_custom_160/sim/dspba_library_package.vhd"                    -work altera_fp_acc_custom_160 -cdslib ./cds_libs/altera_fp_acc_custom_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_acc_custom_160/sim/dspba_library.vhd"                            -work altera_fp_acc_custom_160 -cdslib ./cds_libs/altera_fp_acc_custom_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_fp_acc_custom_160/sim/fpacc64_altera_fp_acc_custom_160_bhzzlly.vhd" -work altera_fp_acc_custom_160 -cdslib ./cds_libs/altera_fp_acc_custom_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fpacc64.vhd"                                                                                                                                                    
fi
